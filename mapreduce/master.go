...
// Applications may call Sequential() instead of Distributed() to get a sequential execution
...
// Applications would normally call Distributed() to start a job
...
func (mr *Master) run(jobName string, files []string, nreduce int,
	...
	finish()
	//The master calls mr.merge() to merge all the nReduce files produced by the previous step into a single output.
	mr.merge()
